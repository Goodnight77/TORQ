    ...
    <nav className={styles.nav} aria-label={t("nav.aria_label")}>
      <div className={styles.inner}>
        <Link to="/" className={styles.brand} onClick={(e) => {
          ...
          <svg aria-hidden="true" className={styles.logoSvg} width="110" height="38" viewBox="0 0 519 182" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <span className="sr-only">{t("logo.aria_label")}</span>
