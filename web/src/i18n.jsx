...
const LOCALES = {
  en: {
    ...
    "dashboard.backend_err": "Backend unreachable — start it with: uv run uvicorn torq.api.main:app",
  ...
  fr: {
    ...
    "dashboard.backend_err": "Backend inaccessible — démarrez-le avec: uv run uvicorn torq.api.main:app",
  ...
  ar: {
    ...
    "dashboard.backend_err": "الخادم الخلفي غير متاح — قم بتشغيله باستخدام: uv run uvicorn torq.api.main:app",
    ...
    "dashboard.needs_review": "يحتاج مراجعة بشرية",
    ...
    "dashboard.money_saved": "مال موفر / سنة",
    ...
    "dashboard.toast_fixed": "تم التحديد كمصلح",
