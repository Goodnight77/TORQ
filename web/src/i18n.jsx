...
const LOCALES = {
  en: {
    ...
    "landing.feature_5_desc": "Report faults from the dashboard — select a machine, enter the code, describe what you see. No sensors, no PLCs, no hardware required.",
    ...
    "landing.step_1_desc": "A floor operator reports it from the dashboard — select the machine, enter the fault code, describe what you see. TORQ starts immediately. No sensors, no PLCs, no hardware required.",
    ...
    "landing.faq_subtitle": "Common questions about TORQ.",
    "landing.faq_card_1_title": "How does TORQ retrieve documentation?",
    "landing.faq_card_1_desc": "We use a hybrid search approach (dense vector + BM25) coupled with a cross-encoder reranker to pinpoint the exact paragraphs needed for any fault code.",
    "landing.faq_card_2_title": "Can I add my own manuals?",
    "landing.faq_card_2_desc": "Yes. TORQ ingests standard PDF manuals, translates them, and chunks them automatically into the knowledge base.",
    "landing.faq_card_3_title": "What languages are supported?",
    "landing.faq_card_3_desc": "Currently, the TORQ agent outputs in English, French, and Arabic to support diverse maintenance teams.",
    "landing.faq_card_4_title": "Is my factory data secure?",
    "landing.faq_card_4_desc": "Absolutely. TORQ runs entirely on isolated infrastructure with zero data leakage to public models.",
    ...
    "dashboard.manual_form_hint": "Select a machine, enter the fault code, and describe what you see or hear.",
    "dashboard.machine_placeholder": "Select machine…",
    ...
    "dashboard.operator_link": "Mobile report",
    "dashboard.operator_link_hint": "Open on any phone →",
    ...
    "dashboard.toast_fault_reported": "Fault reported",
    "dashboard.stage_fault_received": "Fault detected",
    "dashboard.stage_diagnosing": "Diagnosing",
    "dashboard.stage_work_order_created": "Work order ready",
    "dashboard.stage_approved": "Approved",
    "dashboard.stage_dispatched": "Dispatched",
    "dashboard.stage_dispatch_failed": "Dispatch failed",
    "dashboard.stage_rejected": "Rejected",
    "dashboard.activity_log": "Activity log",
    "dashboard.no_activity": "No activity yet",
    "dashboard.send_whatsapp": "Send WhatsApp to technician",
    "dashboard.load_error": "Could not load data — check connection",
    "dashboard.clear_search": "Clear search",
    "dashboard.whatsapp_sent": "WhatsApp sent to technician",
    "dashboard.filter_by_status": "Filter by status",
    "dashboard.confirm_reject": "Reject this work order?",
    "dashboard.cancel": "Cancel",
    "error_boundary.title": "Something went wrong",
    "error_boundary.reload": "Reload page",
    "not_found.title": "Page not found",
    "not_found.back": "Back to home",
    "theme_toggle.light": "Switch to light mode",
    "theme_toggle.dark": "Switch to dark mode",
    "dashboard.steps": "steps",
    "nav.aria_label": "Main navigation",
    "nav.skip_to_content": "Skip to content",
    "logo.aria_label": "TORQ home",
    "app.title": "TORQ — Fault-to-Fix Engine",
  },
  fr: {
    ...
    "landing.faq_title": "FAQ",
    "landing.faq_subtitle": "Questions fréquentes sur TORQ.",
    "landing.faq_card_1_title": "Comment TORQ récupère-t-il la documentation ?",
    "landing.faq_card_1_desc": "Nous utilisons une approche de recherche hybride (vecteur dense + BM25) couplée à un reclassement cross-encoder pour identifier les paragraphes exacts nécessaires pour tout code d'erreur.",
    "landing.faq_card_2_title": "Puis-je ajouter mes propres manuels ?",
    "landing.faq_card_2_desc": "Oui. TORQ ingère les manuels PDF standard, les traduit et les fragmente automatiquement dans la base de connaissances.",
    "landing.faq_card_3_title": "Quelles langues sont prises en charge ?",
    "landing.faq_card_3_desc": "Actuellement, l'agent TORQ produit des sorties en anglais, français et arabe pour soutenir des équipes de maintenance diversifiées.",
    "landing.faq_card_4_title": "Mes données d'usine sont-elles sécurisées ?",
    "landing.faq_card_4_desc": "Absolument. TORQ fonctionne entièrement sur une infrastructure isolée avec zéro fuite de données vers des modèles publics.",
    ...
    "dashboard.manual_form_hint": "Sélectionnez une machine, saisissez le code défaut, et décrivez ce que vous voyez ou entendez.",
    "dashboard.machine_placeholder": "Sélectionner une machine…",
    ...
    "dashboard.operator_link": "Signalement mobile",
    "dashboard.operator_link_hint": "Ouvrir sur un téléphone →",
    ...
    "dashboard.toast_fault_reported": "Défaut signalé",
    "dashboard.stage_fault_received": "Défaut détecté",
    "dashboard.stage_diagnosing": "Diagnostic en cours",
    "dashboard.stage_work_order_created": "Ordre de travail prêt",
    "dashboard.stage_approved": "Approuvé",
    "dashboard.stage_dispatched": "Envoyé",
    "dashboard.stage_dispatch_failed": "Échec d'envoi",
    "dashboard.stage_rejected": "Rejeté",
    "dashboard.activity_log": "Journal d'activité",
    "dashboard.no_activity": "Aucune activité",
    "dashboard.send_whatsapp": "Envoyer WhatsApp au technicien",
    "dashboard.load_error": "Impossible de charger les données — vérifier la connexion",
    "dashboard.clear_search": "Effacer la recherche",
    "dashboard.whatsapp_sent": "WhatsApp envoyé au technicien",
    "dashboard.filter_by_status": "Filtrer par statut",
    "dashboard.confirm_reject": "Rejeter cet ordre de travail ?",
    ...
    "not_found.back": "Retour à l'accueil",
    "theme_toggle.light": "Passer en mode clair",
    "theme_toggle.dark": "Passer en mode sombre",
    "dashboard.steps": "étapes",
    "nav.aria_label": "Navigation principale",
    "nav.skip_to_content": "Aller au contenu",
    "logo.aria_label": "Accueil TORQ",
    "app.title": "TORQ — Moteur de diagnostic de pannes",
  },
  ar: {
    ...
    "navbar.pipeline": "خط الأنابيب",
    "navbar.features": "الميزات",
    "navbar.how_it_works": "كيف يعمل",
    "navbar.faq": "الأسئلة الشائعة",
    "navbar.dashboard": "لوحة التحكم",

    "landing.faq_title": "الأسئلة الشائعة",
    "landing.faq_subtitle": "أسئلة شائعة حول TORQ.",
    "landing.faq_card_1_title": "كيف يسترجع TORQ الوثائق؟",
    "landing.faq_card_1_desc": "نستخدم نهج بحث هجين (متجه كثيف + BM25) مقترنًا بإعادة ترتيب التشفير المتقاطع لتحديد الفقرات الدقيقة اللازمة لأي رمز خطأ.",
    "landing.faq_card_2_title": "هل يمكنني إضافة أدلتي الخاصة؟",
    "landing.faq_card_2_desc": "نعم. يقوم TORQ بقراءة أدلة PDF القياسية، وترجمتها، وتقسيمها تلقائيًا إلى قاعدة المعرفة.",
    "landing.faq_card_3_title": "ما اللغات المدعومة؟",
    "landing.faq_card_3_desc": "حالياً، يخرج وكيل TORQ باللغات الإنجليزية والفرنسية والعربية لدعم فرق الصيانة المتنوعة.",
    "landing.faq_card_4_title": "هل بيانات مصنعي آمنة؟",
    "landing.faq_card_4_desc": "بالتأكيد. يعمل TORQ بالكامل على بنية تحتية معزولة مع عدم تسرب البيانات إلى النماذج العامة.",
    ...
    "dashboard.manual_form_hint": "اختر آلة، أدخل رمز الخلل، وصف ما تراه أو تسمعه.",
    "dashboard.machine_placeholder": "اختر آلة…",
    ...
    "dashboard.operator_link": "إبلاغ من الهاتف",
    "dashboard.operator_link_hint": "فتح على أي هاتف →",
    ...
    "dashboard.toast_fault_reported": "تم الإبلاغ عن الخلل",
    "dashboard.stage_fault_received": "تم اكتشاف العطل",
    "dashboard.stage_diagnosing": "جارٍ التشخيص",
    "dashboard.stage_work_order_created": "أمر العمل جاهز",
    "dashboard.stage_approved": "تمت الموافقة",
    "dashboard.stage_dispatched": "تم الإرسال",
    "dashboard.stage_dispatch_failed": "فشل الإرسال",
    "dashboard.stage_rejected": "مرفوض",
    "dashboard.activity_log": "سجل النشاط",
    "dashboard.no_activity": "لا توجد أنشطة بعد",
    "dashboard.send_whatsapp": "إرسال WhatsApp إلى الفني",
    "dashboard.load_error": "تعذر تحميل البيانات — تحقق من الاتصال",
    "dashboard.clear_search": "مسح البحث",
    "dashboard.whatsapp_sent": "تم إرسال WhatsApp إلى الفني",
    "dashboard.filter_by_status": "تصفية حسب الحالة",
    "dashboard.confirm_reject": "رفض أمر العمل هذا؟",
    "dashboard.cancel": "إلغاء",
    "error_boundary.title": "حدث خطأ ما",
    "error_boundary.reload": "إعادة تحميل الصفحة",
    "not_found.title": "الصفحة غير موجودة",
    "not_found.back": "العودة إلى الصفحة الرئيسية",
    "theme_toggle.light": "التبديل إلى الوضع الفاتح",
    "theme_toggle.dark": "التبديل إلى الوضع الداكن",
    "dashboard.steps": "خطوات",
    "nav.aria_label": "التنقل الرئيسي",
    "nav.skip_to_content": "تخطى إلى المحتوى",
    "logo.aria_label": "الصفحة الرئيسية TORQ",
    "app.title": "TORQ — محرك تحويل الخلل إلى إصلاح",
  },
};
